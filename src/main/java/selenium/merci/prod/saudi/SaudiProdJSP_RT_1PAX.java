...
public class SaudiProdJSP_RT_1PAX extends SeleniumSEPTestAdvanced{
	...
	public static final String FARE_REVIEW_CONTINUE_RT = ".//*[@id='page_wrapper']/form/div/div[15]/div/div/input";
	...
	driver.findElement(By.xpath(FARE_REVIEW_CONTINUE_RT)).click();
